...
export function ListIcon({ color = "#3a30c5" }: { color?: string }) {
    return (
        <svg
            className="w-32 h-32"
            viewBox="0 -0.5 25 25"

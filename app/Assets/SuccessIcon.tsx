...
export function SuccessIcon({ color = "#3a30c5" }: { color?: string }) {
    return (
        <svg
            className="w-32 h-32"
            viewBox="0 0 512 512"
            ...
            <g id="SVGRepo_iconCarrier">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M204.762,254.456l34.212-34.204c-39.807-18.293-88.544-11.079-121.29,21.675c-42.013,42.006-42.013,110.372,0,152.393
                c42.005,42.014,110.38,42.014,152.386,0c32.746-32.745,39.968-81.49,21.675-121.298l-34.211,34.211c3.381,19.976-2.553,41.224-17.939,56.604
                c-25.21,25.218-66.225,25.218-91.434,0c-25.21-25.21-25.21-66.224,0-91.427C163.546,257.016,184.794,251.074,204.762,254.456z"
                    stroke={color}
                    stroke-width="1.5"

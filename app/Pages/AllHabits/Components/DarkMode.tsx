    ...
    return (
        ...
        >
            {darkModeItems.map((singleItem, singleItemIndex) => (
                ...
                >
                    <FontAwesomeIcon
                        className={`${singleItem.isSelected ? "text-customBlue" : "text-gray-300"
                            } cursor-pointer`}
            ...
            <div
                style={{
                    backgroundColor: isDarkMode ?
                        darkModeColor.background : defaultColor.background,
                }}
                className={` w-[38px] absolute h-[38px] top-1 transform ${isDarkMode ? "translate-x-[48px]" : "translate-x-1"

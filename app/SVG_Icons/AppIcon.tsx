...
const AppIcon = ({ color = "#000000", width = "64px", height = "64px" }) => (
    ...
    >
        <g>
            <path
                fill={color}
                d="M502 301.2a10 10 0 1020 0 10 10 0 10-20 0z"
            ></path>
            <path
                fill={color}
                d="M400.3 744.5c2.1-.7 4.1-1.4 6.2-2-2 .6-4.1 1.3-6.2 2zm0 0c2.1-.7 4.1-1.4 6.2-2-2 .6-4.1 1.3-6.2 2z"
            ></path>
            <path
                fill={color}
